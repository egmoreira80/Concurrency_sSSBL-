function [s2j,sigma2j_post,Tjv,Svv,LvjW,scaleJ,scaleLvj] = sSSBLpp(Svv,Lvj,m,W,parcellation)
...
for count_gen = 1:q
    sigma2j_post(count_gen) = sigma2j(count_gen)-sigma2j_post0(count_gen,:)*LvjWsigma2j(:,count_gen);
end
